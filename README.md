...
<подробности>
<краткое описание><strong>Группа в WeChat</strong> (нажмите, чтобы открыть QR-код)</summary>

<img src="./images/wechat-group-cyberstrikeai-qr.jpg" alt="QR-код группы WeChat CyberStrikeAI" width="280">

</подробности>

<подробности>
<краткое описание><сильный>Спонсорство</сильный> (нажмите, чтобы развернуть)</краткое описание>

Если CyberStrikeAI поможет вам, вы можете поддержать проект с помощью **WeChat Pay** или **Alipay**:

<div align="center">
  <img src="./images/sponsor-wechat-alipay-qr.jpg" alt="QR-коды спонсорства WeChat Pay и Alipay" width="480">
деленья
